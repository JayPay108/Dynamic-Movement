...
inFileName = 'OutputTrajectoryData.txt'; % Change to any file name, if left empy the user will be prompted for file name upon execution
...
steerTypes = ["Stop", "Reserved", "Seek", "Flee", "Arrive"];
